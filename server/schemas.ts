...
export const backupPayloadSchema = z.object({
  ...
  pushSettings: z.object({ enabled: z.boolean(), pushplusToken: z.string(), pushplusTopic: z.string(), morningDigestEnabled: z.boolean(), morningDigestTime: z.string(), feedingGapEnabled: z.boolean(), feedingGapLevel1Minutes: z.number().int(), feedingGapLevel2Minutes: z.number().int(), feedPrepEnabled: z.boolean().optional().default(true), feedPrepMinutes: z.number().int().min(0).max(120).optional().default(30), careItemEnabled: z.boolean(), pushSentFlags: z.record(z.string(), z.unknown()), updatedAt: z.string() }).optional(),
