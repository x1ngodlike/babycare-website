...
const LABEL_FOR_PACK: Record<IconPackId, string> = { default: '默认图标', 'basic-shapes': '基础图形', 'hero-pixel-farm': '像素农庄', 'hero-glass-park': '花窗乐园', 'hero-moon-camp': '月球营地', 'hero-jiangnan-market': '江南灯市', 'hero-desert-oasis': '沙漠绿洲', 'hero-dino-museum': '恐龙博馆', 'hero-midsummer-dream': '仲夏夜梦', 'hero-bamboo-court': '青篁小院', 'hero-block-factory': '积木工厂', 'hero-immortal-gate': '云海仙门', 'hero-fruit-cake': '水果蛋糕', 'hero-travel': '云端旅志', 'hero-orbit': '星际观测', 'hero-shop': '晴雨商店', 'hero-arcane': '烛光魔塔', 'hero-ocean': '海底世界', 'hero-forest-press': '林间报社' };
